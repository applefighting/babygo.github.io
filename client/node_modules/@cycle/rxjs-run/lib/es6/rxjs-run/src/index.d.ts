...
import { DisposeFunction, Drivers, Main } from '../../run/src/index';
export declare type MainOutputs<M extends Main> = {
    [k in string & keyof ReturnType<M>]: ReturnType<M>[k] & Observable<any>;
};
export declare type DriverInputs<M extends Main> = {
    [k in string & keyof ReturnType<M>]: ReturnType<M>[k] extends Observable<infer T> ? Stream<T> : never;
};
export declare type DriverOutputs<D extends Drivers> = {
    [k in keyof D]: ReturnType<D[k]>;
};
export declare type MainInputs<D extends Drivers> = {
...
export declare type MatchingDrivers<D extends Drivers, M extends Main> = Drivers & {
    [k in string & keyof MainOutputs<M>]: ((si?: DriverInputs<M>[k]) => DriverOutputs<D>[k]) | ((si: DriverInputs<M>[k]) => DriverOutputs<D>[k]);
};
