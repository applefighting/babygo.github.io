...
export declare type Target = 'local' | 'session';
export declare type StorageRequest = StorageSaveRequest | StorageRemoveRequest | StorageClearRequest;
 ...
 */
declare function storageDriver(request$: Stream<StorageRequest>): ResponseCollection;
